...
routerProveedor.get("/obtener-proveedores/:id_empresa", controllerProveedor.obtenerProveedores);
routerProveedor.get("/obtener-proveedor/:id_proveedor", controllerProveedor.obtenerProveedorPorId);
routerProveedor.post("/crear-proveedor", controllerProveedor.crearProveedor);
