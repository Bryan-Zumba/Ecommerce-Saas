...
/**
 * ItemCarrito - Muestra un producto individual dentro del carrito.
 */
function ItemCarrito({ item }) {
    ...
    return (
      <div className="flex items-center gap-2 bg-white p-2.5 rounded-2xl shadow-sm border border-gray-100">
        ...
        <div className="flex-1 min-w-0 py-0.5 text-left">
          ...
          <div className="flex items-center gap-2 mt-1.5">
            <div className="flex items-center bg-gray-50 rounded-lg p-0.5 border border-gray-100">
              <button onClick={() => actualizarCantidad(item.id, -1)} className="w-5 h-5 flex items-center justify-center rounded-md hover:bg-gray-200 text-gray-600 transition-colors font-bold text-xs">
                -
              </button>
        ...
        <button onClick={() => eliminarDelCarrito(item.id)} className="p-1.5 text-gray-300 hover:text-red-500 transition-colors flex-shrink-0" aria-label="Eliminar">
